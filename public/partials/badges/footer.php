...
<a id="nhcol-evaluation-badge" href="<?php echo $this->plugin_options['evaluate_url']; ?>" title="<?php echo $company_name; ?>">
  <img src="<?php echo $seal_logo_url; ?>" style="width: 100px;" />

  <p class="ratingvalue-name">
    <?php echo $this->plugin_options['translates'][$this->plugin_options['ratingValue']]['name']; ?>
  </p> <!-- .ratingvalue-name -->
